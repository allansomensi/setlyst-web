...
/**
 * A confirmation for destructive or irreversible actions
 * (`role="alertdialog"`). Unlike Dialog it can't be dismissed by a click
 * outside, and focus starts on Cancel. Radix returns focus to the trigger
 * when it closes.
 */
